...
void XamShowPlayersUI()
{
    LOG_WARNING("!!! STUB !!!");
}

void XamShowMessagesUI()
{
    LOG_WARNING("!!! STUB !!!");
}
...
void XamShowGameInviteUI()
{
    LOG_WARNING("!!! STUB !!!");
}

void XamShowFriendRequestUI()
{
    LOG_WARNING("!!! STUB !!!");
}
...
void NetDll_getsockopt()
{
    LOG_WARNING("!!! STUB !!!");
}

void NetDll_getsockname()
{
    LOG_WARNING("!!! STUB !!!");
}

void NetDll_getpeername()
{
    LOG_WARNING("!!! STUB !!!");
}
...
void NetDll_WSACreateEvent()
{
    LOG_WARNING("!!! STUB !!!");
}

void NetDll_WSACloseEvent()
{
    LOG_WARNING("!!! STUB !!!");
}

void NetDll_WSASetEvent()
{
    LOG_WARNING("!!! STUB !!!");
}

void NetDll_WSAWaitForMultipleEvents()
{
    LOG_WARNING("!!! STUB !!!");
}
...
void NetDll_XNetDnsLookup()
{
    LOG_WARNING("!!! STUB !!!");
}

void NetDll_XNetDnsRelease()
{
    LOG_WARNING("!!! STUB !!!");
}
...
void NetDll_XNetQosServiceLookup()
{
    LOG_WARNING("!!! STUB !!!");
}
...
void NetDll_XNetGetEthernetLinkStatus()
{
    LOG_WARNING("!!! STUB !!!");
}
...
void XAudioRegisterRenderDriverClient()
{
    LOG_WARNING("!!! STUB !!!");
}
...
void XAudioSubmitRenderDriverFrame()
{
    LOG_WARNING("!!! STUB !!!");
}
...
void imp_InterlockedFlushSList()
{
    LOG_WARNING("!!! STUB !!!");
}

void imp_InterlockedPopEntrySList()
{
    LOG_WARNING("!!! STUB !!!");
}
...
// AINSLEY
GUEST_FUNCTION_HOOK(__imp__NtPulseEvent, XNotifyGetNext);
...
GUEST_FUNCTION_HOOK(__imp__XamWriteGamerTile, XamWriteGamerTile);
GUEST_FUNCTION_HOOK(__imp__XamUserGetXUID, XamUserGetXUID);
GUEST_FUNCTION_HOOK(__imp__XamShowFriendsUI, XamShowFriendsUI);
GUEST_FUNCTION_HOOK(__imp__XamShowPlayersUI, XamShowPlayersUI);
GUEST_FUNCTION_HOOK(__imp__XamShowMessagesUI, XamShowMessagesUI);
...
GUEST_FUNCTION_HOOK(__imp__XamShowGameInviteUI, XamShowGameInviteUI);
GUEST_FUNCTION_HOOK(__imp__XamShowFriendRequestUI, XamShowFriendRequestUI);
...
GUEST_FUNCTION_HOOK(__imp__NetDll_WSARecv, NetDll_WSARecv);
...
GUEST_FUNCTION_HOOK(__imp__NetDll_WSASetEvent, NetDll_WSASetEvent);
...
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetCreateKey, NetDll_XNetCreateKey);
...
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetQosServiceLookup, NetDll_XNetQosServiceLookup);
...
GUEST_FUNCTION_HOOK(__imp__XNetLogonGetMachineID, XNetLogonGetMachineID);
...
GUEST_FUNCTION_HOOK(__imp__InterlockedFlushSList, imp_InterlockedFlushSList);
GUEST_FUNCTION_HOOK(__imp__InterlockedPopEntrySList, imp_InterlockedPopEntrySList);
